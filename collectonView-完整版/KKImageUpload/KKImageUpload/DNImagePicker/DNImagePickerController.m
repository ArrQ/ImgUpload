                                     ...
                                     usingBlock:^(ALAssetsGroup *assetsGroup, BOOL *stop)
         {
             ...
             if ([assetsGroupID isEqualToString:propwetyID]) {
                 *stop = YES;
                 ...
                 albumTableViewController.maxPhotos = self.maxPhotos;
                 
                 DNImageFlowViewController *imageFlowController = [[DNImageFlowViewController alloc] initWithGroupURL:assetsGroupURL andPhoto:self.maxPhotos];
